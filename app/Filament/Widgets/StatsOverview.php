    ...
    protected function getStats(): array
    {
        ...
        return [
            Stat::make('Total Anggota Aktif', $totalAnggota)
                ...
                ->extraAttributes([
                    'class' => 'ring-2 ring-emerald-200 shadow-md',
                ]),
            ...
            Stat::make('Kegiatan Bulan Ini', $kegiatanBulanIni)
                ...
                ->extraAttributes([
                    'class' => 'ring-2 ring-sky-200 shadow-md',
                ]),
            ...
            Stat::make('Iuran Belum Lunas', $iuranBelumLunas)
                ...
                ->extraAttributes([
                    'class' => 'ring-2 ' . ($iuranBelumLunas > 0 ? 'ring-red-200' : 'ring-emerald-200') . ' shadow-md',
                ]),
            ...
            Stat::make('Pendaftaran Pending', $pendaftaranPending)
                ...
                ->extraAttributes([
                    'class' => 'ring-2 ' . ($pendaftaranPending > 0 ? 'ring-amber-200' : 'ring-emerald-200') . ' shadow-md',
                ]),
        ];
    }
}