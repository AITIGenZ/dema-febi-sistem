...
class UpdateKalenderProkerRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'kegiatan_id' => 'sometimes|required|integer|exists:kegiatans,id',
            'divisi_id' => 'nullable|integer|exists:divisis,id',
            'tgl_mulai' => 'sometimes|required|date|date_format:Y-m-d',
