...
{{-- KALENDER PROKER --}}
  ...
  <div style="max-width:720px; margin:0 auto;">
    ...
    <span style="color:#1a9090;font-size:10px;font-weight:800;letter-spacing:.18em;text-transform:uppercase;display:block;margin-bottom:10px;text-align:center;">Agenda</span>
    <h2 style="color:#f5f0e8;font-size:28px;font-weight:800;text-align:center;margin-bottom:6px;">Kalender Program Kerja</h2>
    <p style="color:rgba(245,240,232,0.5);font-size:13px;text-align:center;margin-bottom:36px;">Jadwal dan agenda kegiatan DEMA FEBI sepanjang tahun</p>

    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:20px;">
      <button id="cal-prev" style="background:rgba(26,144,144,0.15);border:1.5px solid rgba(26,144,144,0.3);color:#1a9090;width:38px;height:38px;border-radius:50%;font-size:20px;cursor:pointer;">&#8249;</button>
      <div style="text-align:center;">
        <div id="cal-month" style="color:#1a9090;font-size:22px;font-weight:900;text-transform:uppercase;letter-spacing:.06em;"></div>
        <div id="cal-year" style="color:#f5f0e8;font-size:15px;font-weight:700;margin-top:2px;"></div>
      </div>
      <button id="cal-next" style="background:rgba(26,144,144,0.15);border:1.5px solid rgba(26,144,144,0.3);color:#1a9090;width:38px;height:38px;border-radius:50%;font-size:20px;cursor:pointer;">&#8250;</button>
    </div>

    <div style="display:grid;grid-template-columns:repeat(7,1fr);gap:4px;margin-bottom:6px;">
      @foreach(['Min','Sen','Sel','Rab','Kam','Jum','Sab'] as $h)
        <div style="text-align:center;color:#1a9090;font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:.08em;padding:6px 0;">{{ $h }}</div>
      @endforeach
    </div>

    <div id="cal-grid" style="display:grid;grid-template-columns:repeat(7,1fr);gap:4px;"></div>

    <div id="cal-popup" style="display:none;margin-top:16px;background:#eee8d8;border-radius:16px;padding:20px 22px;border:1px solid rgba(26,122,122,0.2);">
      <button id="cal-close" style="float:right;background:none;border:none;color:#7a9090;cursor:pointer;font-size:18px;">&#10005;</button>
      <div style="color:#1a7a7a;font-size:10px;font-weight:800;letter-spacing:.14em;text-transform:uppercase;margin-bottom:12px;">Kegiatan</div>
